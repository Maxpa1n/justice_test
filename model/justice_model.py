...
from model.file_utils import add_start_docstrings_to_callable
from model.modeling_albert import AlbertPreTrainedModel, AlbertModel, ALBERT_INPUTS_DOCSTRING
from model.modeling_bert import BertModel, BertPreTrainedModel
import torch.nn as nn

from model.modeling_bert import BERT_INPUTS_DOCSTRING


class BertForJustice(AlbertPreTrainedModel):
...
class AlbertForJustice(AlbertPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
    ...
    class BertForJustice(BertPreTrainedModel):
        def __init__(self, config):
            super().__init__(config)
